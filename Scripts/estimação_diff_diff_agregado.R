...
#ggsave(file = "Figuras/suporte_comum_2011_2014_quantis.png")
...
g_suporte_comum <- plot_grid(grafico_suporte_comum_2009_2012, grafico_suporte_comum_2010_2013, grafico_suporte_comum_2011_2014,
                             nrow = 3, labels = c("a) 2009-2012 cycle",
                                                  "b) 2010-2013 cycle",
                                                  "c) 2011-2014 cycle"),
                             label_size = 10, label_fontface = "plain", scale = 1)

#ggsave(filename = "Figuras/suporte_comum_agregado.eps")


  ## 2) BALANCEAMENTO DAS COVARIADAS ####

g_balanceamento <- plot_grid(g2_2009_2012, g2_2010_2013, g2_2011_2014, nrow = 3,
                             labels = c("a) 2009-2012 cycle",
                                        "b) 2010-2013 cycle",
                                        "c) 2011-2014 cycle"),
                             label_size = 10, label_fontface = "plain", scale = 1)

#ggsave(filename = "Figuras/balanceamento_agregado.eps")
...
#ggsave(filename = "Figuras/balanceamento_placebo_agregado.eps")
