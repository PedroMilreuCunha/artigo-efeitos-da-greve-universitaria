...
grafico_densidade_notas_direito <- ggplot(painel_direito, aes(x = nota_media, fill = Tratamento))+
                                   ...
                                   scale_fill_manual(labels=c("Control", "Tratamento"),
                                                     values = c("red", "navy")) +
                                   theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_direito.eps")
...
grafico_densidade_log_notas_direito <- ggplot(painel_direito, aes(x = log_nota, fill = Tratamento))+
                                       geom_density(alpha = 0.25) +
                                       labs(x = "log(Mean score)", y = "Density", fill = "Group")+
                                       scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                       theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_log_notas_direito.eps")
...
grafico_densidade_notas_economia <- ggplot(painel_ciencias_economicas, aes(x = nota_media, fill = Tratamento))+
                                    ...
                                    scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                    theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_economia.eps")
...
grafico_densidade_log_notas_ciencias_economicas <- ggplot(painel_ciencias_economicas, aes(x = log_nota, fill = Tratamento))+
                                                   ...
                                                   scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                                   theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_log_notas_economia.eps")
...
grafico_densidade_notas_medicina <- ggplot(painel_medicina, aes(x = nota_media, fill = Tratamento))+
                                    ...
                                    scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                    theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_medicina.eps")
...
grafico_densidade_log_notas_medicina <- ggplot(painel_medicina, aes(x = log_nota, fill = Tratamento))+
                                        ...
                                        scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                        theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_log_notas_medicina.eps")
...
grafico_densidade_notas_agronomia <- ggplot(painel_agronomia, aes(x = nota_media, fill = Tratamento))+
                                          ...
                                          scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                          theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_agronomia.eps")
...
grafico_densidade_log_notas_agronomia <- ggplot(painel_agronomia, aes(x = log_nota, fill = Tratamento))+
                                              ...
                                              scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                              theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_log_notas_agronomia.eps")
...
grafico_densidade_notas_historia <- ggplot(painel_historia, aes(x = nota_media, fill = Tratamento))+
                                    ...
                                    scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                    theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_historia.eps")
...
grafico_densidade_log_notas_historia <- ggplot(painel_historia, aes(x = log_nota, fill = Tratamento))+
                                        ...
                                        scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                        theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_log_notas_historia.eps")
...
grafico_densidade_notas_engenharia_quimica <- ggplot(painel_engenharia_quimica, aes(x = nota_media, fill = Tratamento))+
                                              ...
                                              scale_fill_manual(labels=c("Control", "Tratamento"),                                              values = c("red", "navy")) +
                                              theme(panel.grid = element_blank())
#ggsave(filename = "Figuras/grafico_densidade_notas_engenharia_quimica.eps")
...
#ggsave(filename = "Figuras/grafico_densidade_log_notas_engenharia_quimica.eps")
...
names <- data.frame(old = c("idade_media", "idade2_media", "prop_brancos",
                            ...
                            "prop_renda_3SM"),
                    new = c("Mean age", "Mean age²",
                            "Prop. of whites", "Prop. of married",
                            "Prop. of men", "Prop. of mothers with highschool education or higher",
                            "Prop. of students with family income of 3M.W. or less"))

names_placebo <- data.frame(old = c("prop_casados", "prop_brancos",
                                    "log_nota", "prop_homens", "prop_medio_ou_mais",
                                    "prop_renda_3SM"),
                            new = c("Prop. of married",
                                    "Prop. of whites", "log(mean score)",
                                    "Prop. of men", "Prop. of mother with highschool education or higher",
                                    "Prop. of students with family income of 3M.W. or less"))
...
grafico_tendencias_direito <- ggplot(painel_direito, aes(Ano, log_nota, color = Tratamento))+
                              ...
                              labs(x = "Year", y = "log(Mean score)", color = "Group")+
                              geom_vline(xintercept = 2012, linetype = "dashed", col = "black", size = 0.5) +
                              scale_colour_manual(labels=c("Control", "Tratamento"),
                                                  values=c("red", "navy"))+
                              theme(panel.grid = element_blank())

#ggsave(file = "Figuras/tendencias_direito.eps")
...
#ggsave(file = "Figuras/tendencias_economia.eps")
...
#ggsave(file = "Figuras/tendencias_medicina.eps")
...
#ggsave(file = "Figuras/tendencias_agronomia.eps")
...
#ggsave(file = "Figuras/tendencias_historia.eps")
...
#ggsave(file = "Figuras/tendencias_engenharia_quimica.eps")
...
#ggsave(file = "Figuras/suporte_comum_direito.eps")
...
#ggsave(file = "Figuras/suporte_comum_direito_quantis.eps")
...
g1_direito <- love.plot(W1, stats = c("m"), drop.distance = TRUE,
              ...
              sample.names = c("PS-weighted", "Unweighted"),
              title = NULL,
              line= T,
              var.names = names,
              colors = c("red", "navy"),
...
g2_direito <- love.plot(W2, stats = c("m"), drop.distance = TRUE,
              ...
              wrap = 10,
              var.order = "unadjusted",
              sample.names = c("Entropy-weighted", "Unweighted"),
              title = NULL,
...
#ggsave(file = "Figuras/suporte_comum_ciencias_economicas.eps")
...
#ggsave(file = "Figuras/suporte_comum_ciencias_economicas_quantis.eps")
...
#ggsave(file = "Figuras/suporte_comum_medicina.eps")
...
#ggsave(file = "Figuras/suporte_comum_medicina_quantis.eps")
...
#ggsave(file = "Figuras/suporte_comum_agronomia.eps")
...
#ggsave(file = "Figuras/suporte_comum_agronomia_quantis.eps")
...
#ggsave(file = "Figuras/suporte_comum_engenharia_quimica.eps")
...
#ggsave(file = "Figuras/suporte_comum_engenharia_quimica_quantis.eps")
...
#ggsave(file = "Figuras/suporte_comum_historia.eps")
...
#ggsave(file = "Figuras/suporte_comum_historia_quantis.eps")
...
g_2009_2012 <- plot_grid(grafico_suporte_comum_ciencias_economicas, grafico_suporte_comum_direito, ncol = 2,
                         labels = c("a) Economics", "b) Law"), label_size = 8, label_fontface = "bold", scale = 0.75, label_y = 0)
g_2010_2013 <- plot_grid(grafico_suporte_comum_agronomia, grafico_suporte_comum_medicina, ncol = 2,
                         labels = c("a) Agronomy", "b) Medicine"), label_size = 8, label_fontface = "bold", scale = 0.75, label_y = 0)
g_2011_2014 <- plot_grid(grafico_suporte_comum_engenharia_quimica, grafico_suporte_comum_historia, ncol = 2,
                         labels = c("a) Chemical eng.", "b) History"), label_size = 8, label_fontface = "bold", scale = 0.75, label_y = 0)

g_suporte_comum <- plot_grid(g_2009_2012, g_2010_2013, g_2011_2014, nrow = 3,
                             labels = c("1) 2009-2012 cycle",
                                        "2) 2010-2013 cycle",
                                        "3) 2011-2014 cycle"),
                             label_size = 8, label_fontface = "bold", scale = 0.75)

#ggsave("Figuras/suporte_comum_areas.eps", height = 12, width = 8)

## 2) TENDÊNCIAS ####

g_tendencia_2009_2012 <- plot_grid(grafico_tendencias_economia, grafico_tendencias_direito, ncol = 2, vjust = 0, 
                         labels = c("a) Economics", "b) Law"), label_size = 7, label_fontface = "bold", scale = 0.75,label_y = 0)
g_tendencia_2010_2013 <- plot_grid(grafico_tendencias_agronomia, grafico_tendencias_medicina, ncol = 2, vjust = 0,
                         labels = c("a) Agronomy", "b) Medicine"), label_size = 7, label_fontface = "bold", scale = 0.75,label_y = 0)
g_tendencia_2011_2014 <- plot_grid(grafico_tendencias_engenharia_quimica, grafico_tendencias_historia, ncol = 2, vjust = 0,
                         labels = c("a) Chemical eng.", "b) History"), label_size = 7, label_fontface = "bold", scale = 0.75,label_y = 0)
...
ggsave("Figuras/tendencias_por_area.eps", height = 12, width = 8)

## 3) BALANCEAMENTO DAS COVARIADAS ####


g_balanceamento_2009_2012 <- plot_grid(g2_economia, g2_direito, nrow = 2, labels = c("a) Economics", "b) Law"),
                                       label_size = 7, label_fontface = "bold")


g_balanceamento_2010_2013 <- plot_grid(g2_agronomia, g2_medicina, nrow = 2, labels = c("a) Agronomy", "b) Medicine"),
                                       label_size = 7, label_fontface = "bold")

g_balanceamento_2011_2014 <- plot_grid(g2_engenharia_quimica, g2_historia, nrow = 2, labels = c("a) Chemical eng.", "b) History"),
                                       label_size = 7, label_fontface = "bold")


g_balanceamento_placebo_2009_2012 <- plot_grid(g3_economia, g3_direito, ncol = 2, labels = c("a) Economics", "b) Law"),
                                       label_size = 7, label_fontface = "bold")

#ggsave("Figuras/balanceamento_placebo_2009_2012.eps", height = 12, width = 8)

g_balanceamento_placebo_2010_2013 <- plot_grid(g3_agronomia, g3_medicina, ncol = 2, labels = c("a) Agronomy", "b) Medicine"),
                                       label_size = 7, label_fontface = "bold")

#ggsave("Figuras/balanceamento_placebo_2010_2013.eps", height = 12, width = 8)


g_balanceamento_placebo_2011_2014 <- plot_grid(g3_engenharia_quimica, g3_historia, ncol = 2, labels = c("a) Chemical eng.", "b) History"),
                                       label_size = 7, label_fontface = "bold")

#ggsave("Figuras/balanceamento_placebo_2010_2014.eps", height = 12, width = 8)
